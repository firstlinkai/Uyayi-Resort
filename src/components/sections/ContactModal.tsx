...
import { X, Mail, MapPin, Send, Facebook, Instagram } from 'lucide-react';
...
export const ContactModal = ({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.location.href = `mailto:info@firstlinkai.com?subject=${subject}&body=${body}`;
  };
          ...
          >
            ...
            <div className="flex-1 p-8 md:p-12 lg:p-16 bg-white/[0.02] flex flex-col justify-between">
              <div className="space-y-10">
                ...
                <div className="space-y-3">
                  <h3 className="text-xs tracking-[0.3em] uppercase font-bold text-golden-sunset">Email Us</h3>
                  <div className="space-y-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex flex-col">
                        <p className="text-sm font-open-sans text-soft-silver font-bold">info@firstlinkai.com</p>
                        <p className="text-[10px] text-soft-silver/40 uppercase tracking-widest">Enquiries</p>
                      </div>
                    </div>
                  </div>
                </div>
